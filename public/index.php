            ...
            <div class="container">
                ...
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active"><a href="#" class="nav-link">Accueil <span class="sr-only"></span></a></li>
        ...
        <div class="px-sm-5 py-sm-4 text-white">
            <div class="row h-100 mt-sm-0 justify-content-center">
                <div class="row text-center mt-sm-0 ">
                    <div class="col my-auto px-3 px-sm-5">
                        <p class="text-white text-title cover-title mb-0 false">Burger Company</p>
                        <div class="px-lg-5 px-0">
                            <p class="line-break cover-description mb-3 px-lg-5 px-0"> Commandez vos plats préférés en quelques clics !</p>
                        </div>
                    </div>
                </div>
            </div>
